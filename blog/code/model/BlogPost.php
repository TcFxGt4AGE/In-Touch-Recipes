...
class BlogPost extends Page
{
    ...
    public function getCMSFields()
    {
		...
		$fields->addFieldToTab('Root.Main', TextareaField::create('Ingredients'), 'Content');
		$fields->addFieldToTab('Root.Main', TextField::create('Preparation','Preparation Time'), 'Content');
		$fields->addFieldToTab('Root.Main', TextField::create('Cooking','Cooking Time'), 'Content');
